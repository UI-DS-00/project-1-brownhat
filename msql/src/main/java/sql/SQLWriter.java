...
public class SQLWriter {
    public static void akaWriter(String titleId,int ordering,String region,String language,
                                 String types,String attributes,int isOriginal) throws ClassNotFoundException, SQLException {
    ...
    public static void nameBasicsWriter(String nConst,long personID,String primaryName,int birthYear,int deathYear
            ,String primaryProfession,String knownFor) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void titleBasicWriter(String titleId,String titleType,String primaryTitle,
                                        String originalTitle,int isAdult,int startYear,int endYear,
                                        int runtimeMinute,String genre) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void episodeWriter(String tConst,String parentConst,int seasonNumber,int episodeNumber) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void principalWriter(String tConst,int ordering,String nConst,String category,String job,String characters) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void crewWriter(String titleID,String directors,String writers) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    public static void ratingWriter(String tConst,double average,int numberOfVotes) throws ClassNotFoundException, SQLException {
        String url = "jdbc:mysql://localhost/dsproject";
        String uname = "root";
        String pw = "12345678";
        Class.forName("com.mysql.cj.jdbc.Driver");
